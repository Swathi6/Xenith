...
namespace Xenith.admin
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void Signin_Click(object sender, EventArgs e)
        {
            ...
            String qry1 = "select * from sysuser where sysuser_login='" + inpusername + "' and (sysuser_role=1 OR sysuser_role=2)";
            ...
            if (allowlogin == true)
            {
                Session["admusernamex"] = inpusername;
                Session["admuseridx"] = zuserid;
                Session["admfnamex"] = zfname;
                Session["admlnamex"] = zlname;
                Response.Redirect("index.aspx");
            }
            else
            {
