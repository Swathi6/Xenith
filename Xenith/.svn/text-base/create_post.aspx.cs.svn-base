...
namespace Xenith
{
    public partial class create_post: System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("insert into forum_posts (forum_topic, no_of_comments, forum_content, created_time, user_id) values (@topic,'" + no_of_comments + "',@content, @time, @default_user_id)", db);
